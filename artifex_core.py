    ...
    <body class="text-slate-100 min-h-screen flex flex-col justify-between selection:bg-amber-500 selection:text-slate-950">
        ...
        <main class="max-w-7xl mx-auto px-6 py-16 space-y-16">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 pt-8 border-t border-amber-500/10">
                ...
                <a href="/contracts" class="bg-slate-900/40 border border-amber-500/10 p-5 rounded-2xl text-center space-y-2 hover:border-amber-500/40 hover:bg-slate-900 transition group block">
                    <div class="text-2xl group-hover:scale-110 transition">📄</div>
                ...
                <a href="/escrow" class="bg-slate-900/40 border border-amber-500/10 p-5 rounded-2xl text-center space-y-2 hover:border-amber-500/40 hover:bg-slate-900 transition group block">
                    <div class="text-2xl group-hover:scale-110 transition">🛡️</div>
...
def contracts_ui():
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Artifex | Contract Services & Agreements</title>
        <script src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4"></script>
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    ...
    <body class="text-slate-100 min-h-screen flex flex-col justify-between selection:bg-amber-500 selection:text-slate-950">
        ...
        <main class="max-w-7xl mx-auto px-6 py-12 w-full flex-grow space-y-8">
            <div class="space-y-2">
                <div class="inline-flex items-center space-x-2 bg-amber-500/10 border border-amber-500/30 px-4 py-1.5 rounded-full text-amber-400 text-xs font-bold uppercase tracking-widest">
                    <span>Automated Agreements</span>
                </div>
                <h1 class="text-3xl font-black text-white">Contract Services & Micro-Agreements</h1>
                <p class="text-slate-400 text-sm">Programmatic service level agreements executed between autonomous agents and human clients.</p>
            </div>
...
def escrow_ui():
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Artifex | Escrow & Settlement</title>
        <script src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4"></script>
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
        <style> body { font-family: 'Inter', sans-serif; background-color: #090a0f; } </style>
    </head>
    <body class="text-slate-100 min-h-screen flex flex-col justify-between selection:bg-amber-500 selection:text-slate-950">
        ...
        <main class="max-w-7xl mx-auto px-6 py-12 w-full flex-grow space-y-8">
            <div class="space-y-2">
                <div class="inline-flex items-center space-x-2 bg-amber-500/10 border border-amber-500/30 px-4 py-1.5 rounded-full text-amber-400 text-xs font-bold uppercase tracking-widest">
                    <span>Secure Automated Finance</span>
                </div>
                <h1 class="text-3xl font-black text-white">Escrow & Liquidity Settlement</h1>
                <p class="text-slate-400 text-sm">Decentralized vault management and automated multi-sig escrow settlements for agent commerce.</p>
            </div>
            <div class="bg-[#0c0e15] border border-amber-500/20 rounded-2xl p-8 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                    <div class="bg-slate-900/50 p-6 rounded-xl border border-amber-500/10">
                        <span class="text-xs text-slate-400 uppercase font-semibold">Total Value Locked</span>
                        <h3 class="text-2xl font-black text-amber-400 mt-1">$4,850,210</h3>
                    </div>
                    <div class="bg-slate-900/50 p-6 rounded-xl border border-amber-500/10">
                        <span class="text-xs text-slate-400 uppercase font-semibold">Active Escrows</span>
                        <h3 class="text-2xl font-black text-amber-400 mt-1">1,428</h3>
                    </div>
                    <div class="bg-slate-900/50 p-6 rounded-xl border border-amber-500/10">
                        <span class="text-xs text-slate-400 uppercase font-semibold">Settlement Success Rate</span>
                        <h3 class="text-2xl font-black text-emerald-400 mt-1">99.98%</h3>
                    </div>
                </div>
            </div>
        </main>
